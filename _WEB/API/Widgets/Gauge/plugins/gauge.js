...
class EmicWidgetGauge extends EmicWidget {
    gauge;
    static namesList = {};
    getNewID() {
        var i;
        for (i = 1; EmicWidgetGauge.namesList[`gauge-${i}`]; i++);
        EmicWidgetGauge.namesList[`gauge-${i}`] = this;
        return `gauge-${i}`;
    }
    ...
    connectedCallback() {
        ...
        if (!super.preconnectedCallback("Gauge")) {
            return;
        }
...
customElements.define("emic-widget-gauge", EmicWidgetGauge);
