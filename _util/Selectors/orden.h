/*RFI JSon
{
	...
	"FunctionReturn": "",
	"FunctioNParametros": "n",
	"InnerHTML": "
	<div class='lineaDeCodigo blokOnSection' location='_util/Selectors/ultimo.c' definir='useOrdenV1' originalclass='funcion' originalid='ultimo' draggable='true' ondragstart='drag_linea(event)'>&#x2329;
